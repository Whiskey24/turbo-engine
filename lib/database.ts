...
export { ASSET_TYPE_SLUGS, COUPON_FREQUENCIES, COUPON_FREQUENCY_LABELS, DAY_COUNT_BASES, TRANSACTION_TYPES } from "@/lib/database.types";
export type { AssetTypeSlug, CouponFrequency, DayCountBasis, TransactionType } from "@/lib/database.types";

// ---------------------------------------------------------------------------
// Base table row / insert types
// ---------------------------------------------------------------------------

export type AssetType = Tables<"asset_categories">;
